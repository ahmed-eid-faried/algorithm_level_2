...
void CopyArrayFun(int Array[100], short ArrLength, int CopyArray[100], short& CopyArrLength) {
	for (short i = 0; i < ArrLength; i++)
	{
		AddElementToSimiDynamicArray(Array[i], CopyArray, CopyArrLength);
	}
}
...
int main() {
	...
	cout << "============================================" << endl;
	CopyArrayFun(Array, ArrLength, CopyArray, CopyArrLength);
